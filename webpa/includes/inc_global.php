...
define('APP__WWW', '/webpa');
define('DOC__ROOT','E:\xampp\htdocs\webpa/'); //must include the trailing /
...
// logo
define('APP__INST_LOGO', APP__WWW.'/images/');
define('APP__INST_LOGO_ALT','University of Huddersfield');
