...
?>
        <div class="obj">
          ...
          <tr>
            <td class="icon" width="24"><a href="<?php echo($clone_url); ?>"><img src="../../images/icons/form.svg" width="24" height="24" alt="Form" /></a></td>
            <td class="obj_info">
...
?>
          <div class="obj">
            <table class="obj" cellpadding="2" cellspacing="2">
            <tr>
              <td class="icon" width="24"><a href="<?php echo($edit_url); ?>"><img src="../../images/icons/form.svg" width="24" height="24" alt="Form" /></a></td>
              <td class="obj_info">
